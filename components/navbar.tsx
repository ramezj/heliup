...
export function Navigation(props:any) {
  ...
  return (
    <div className="flex w-full flex-col">
      <header className="sticky top-2 mt-6 flex h-16 items-center gap-4 bg-black/70 px-4 z-50 md:mx-12 mx-4 rounded-xl border border-foreground/20 backdrop-blur-lg">
