...
export function BentoDemo() {
  return (
    <BentoGrid>
        ...
        background={
        <>
        <Input className="absolute right-0 top-10 origin-top rounded-md border transition-all duration-300 ease-out group-hover:scale-105" value={"demo.heliup.xyz"} disabled />
        </>
        }/>
        ...
        cta="Start Hiring"
        background={
          <div className="gap-2 flex flex-col absolute right-0 top-10 origin-top rounded-md transition-all duration-300 ease-out group-hover:scale-105">
